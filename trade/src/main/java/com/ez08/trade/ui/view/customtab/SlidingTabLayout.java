...
package com.ez08.trade.ui.view.customtab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_TEXT_SIZE_SP = 15;     //text size
...
//        setBackgroundColor(Color.RED);
     ...
     */
    protected TextView createDefaultTabView(Context context, int bottom) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            paint.setTextSize(ScreenUtil.spToPx(getContext(),TAB_VIEW_TEXT_SIZE_SP));
            Paint.FontMetricsInt fontMetrics = paint.getFontMetricsInt();
            int bottom =  fontMetrics.ascent - fontMetrics.top;

            if (tabView == null) {
                tabView = createDefaultTabView(getContext(),bottom);
            }
            ...
            LinearLayout.LayoutParams ll = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT);
            ll.weight = 1;
            tabTitleView.setLayoutParams(ll);
    ...
    private void setTextChange(int position){
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            ...
            if(i == position) {
                textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP + 3);
    ...
    static class MySavedState extends BaseSavedState {
        ...
        public static final Creator<MySavedState> CREATOR = new Creator<MySavedState>(){
