...
public class Level1VerticalView extends LinearLayout implements Level, View.OnClickListener {
    ...
    public Level1VerticalView(Context context) {
        super(context);
    }

    public Level1VerticalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
