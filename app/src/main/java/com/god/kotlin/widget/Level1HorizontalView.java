...
import com.ez08.trade.ui.view.OnFiveListener;
...
//        bat(sellPrice5,sellVol5,ask,4);
    ...
    public void setData1(TradeStockEntity entity) {
        this.entity = entity;
        this.ask = entity.ask;
        this.bid = entity.bid;
    ...
    private void bat(TextView price, TextView volume, List<TradeStockEntity.Dang> list, int position) {
